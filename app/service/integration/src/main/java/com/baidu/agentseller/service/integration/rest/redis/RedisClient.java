package com.baidu.agentseller.service.integration.rest.redis;
...
public class RedisClient {
    ...
    private static RedisClient ru = new RedisClient();

    private RedisClient() {
        if (pool == null) {
            String ip = "nmg01-hpc-nj-w0016.nmg01.baidu.com";
            int port = 18000;
    ...
    public static RedisClient getRu() {
        return ru;
    }

    public static void setRu(RedisClient ru) {
        RedisClient.ru = ru;
    }
}