...
import com.baidu.agentseller.service.impl.wechat.config.MainConfiguration;
import com.baidu.agentseller.service.impl.wechat.config.WxPayConfiguration;
...
public class CoreController extends GenericController {
    ...
    /**
     * 通过openid获得基本用户信息 详情请见: http://mp.weixin.qq.com/wiki/14/bb5031008f1494a59c6f71fa0f319c66.html
     *
     * @param response
     * @param openid openid
    ...
    /**
     * 通过code获得基本用户信息 详情请见: http://mp.weixin.qq.com/wiki/14/bb5031008f1494a59c6f71fa0f319c66.html
     *
     * @param response
     * @param code code
     * @param lang zh_CN, zh_TW, en
    ...
    /**
     * 用code换取oauth2的openid 详情请见: http://mp.weixin.qq.com/wiki/1/8a5ce6257f1d3b2afb20f83e72b72ce9.html
     *
     * @param response
     * @param code code
     */
