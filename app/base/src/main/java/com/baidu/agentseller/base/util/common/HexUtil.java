...
public class HexUtil {
     ...
     * @throws IllegalStateException if the charsetName is invalid. This API throws {@link IllegalStateException}
     *             instead of {@link UnsupportedEncodingException} for backward compatibility.
     * @see #encodeHex(byte[])
     */
    ...
    public Object encode(Object object) throws Exception {
        try {
            byte[] byteArray =
                    object instanceof String ? ((String) object).getBytes(getCharsetName()) : (byte[]) object;
